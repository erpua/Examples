...
/* 
Передаю в функцию массив пользователей и искомое имя в качестве аргументов, затем фильтрую массив функцией фильтр, а потом использую метод find
...
/* 
1. hasOwnProperty(name) - ето метод обьекта!

для поиска в масиве используй - includes(name)
масив дрезей вытягивать не нужно
const getUsersByFriend = (users, name) => {
