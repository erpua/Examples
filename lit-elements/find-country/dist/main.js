 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=` ${c} `;class v{constructor(e,t,s,n){this.strings=e,this.values=t,this.type=s,this.processor=n}getHTML(){const e=this.strings.length-1;let t="",s=!1;for(let n=0;n<e;n++){const e=this.strings[n],i=e.lastIndexOf("\x3c!--");s=(i>-1||s)&&-1===e.indexOf("--\x3e",i+1);const r=f.exec(e);t+=null===r?e+(s?y:h):e.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+c}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const k=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new N(e,t.slice(1),s).parts}return"@"===i?[new E(e,t.slice(1),n.eventContext)]:"?"===i?[new C(e,t.slice(1),s)]:new b(e,t,s).parts}handleTextExpression(e){return new P(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const R=(e,...t)=>new v(e,t,"html",k);function $(e,t){const{element:{content:s},parts:n}=e,i=document.createTreeWalker(s,133,null,!1);let r=L(n),o=n[r],a=-1,l=0;const c=[];let h=null;for(;i.nextNode();){a++;const e=i.currentNode;for(e.previousSibling===h&&(h=null),t.has(e)&&(c.push(e),null===h&&(h=e)),null!==h&&l++;void 0!==o&&o.index===a;)o.index=null!==h?-1:o.index-l,r=L(n,r),o=n[r]}c.forEach(e=>e.parentNode.removeChild(e))}const q=e=>{let t=11===e.nodeType?0:1;const s=document.createTreeWalker(e,133,null,!1);for(;s.nextNode();)t++;return t},L=(e,t=-1)=>{for(let s=t+1;s<e.length;s++){const t=e[s];if(m(t))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const K=e=>e.flat?e.flat(1/0):function e(t,s=[]){for(let n=0,i=t.length;n<i;n++){const i=t[n];Array.isArray(i)?e(i,s):s.push(i)}return s}(e);class Y extends X{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const e=this.styles,t=[];if(Array.isArray(e)){K(e).reduceRight((e,t)=>(e.add(t),e),new Set).forEach(e=>t.unshift(e))}else e&&t.push(e);return t}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?G?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){super.update(e);const t=this.render();t instanceof v&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){}}Y.finalized=!0,Y.render=(e,t,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const n=s.scopeName,i=M.has(t),r=z&&11===t.nodeType&&!!t.host,a=r&&!F.has(n),l=a?document.createDocumentFragment():t;if(((e,t,s)=>{let n=M.get(t);void 0===n&&(o(t,t.firstChild),M.set(t,n=new P(Object.assign({templateFactory:O},s))),n.appendInto(t)),n.setValue(e),n.commit()})(e,l,Object.assign({templateFactory:I(n)},s)),a){const e=M.get(l);M.delete(l);const s=e.value instanceof g?e.value.template:void 0;W(n,l,s),o(t,t.firstChild),t.appendChild(l),M.set(t,e)}!i&&r&&window.ShadyCSS.styleElement(t.host)};customElements.define("searcher-element",class extends Y{render(){return R`
    ...
    `}get matchAlert(){return this.shadowRoot.querySelector(".match-alert")}markupCountry(e){return`<p class="country-name">${e.name}</p>\n          <div class="description">\n            <div>\n             <p><span class="headline">Capital:</span> ${e.capital}</p>\n              <p><span class="headline">Population:</span> ${e.population}</p>\n               <p><span class="headline">Languages:</span></p>\n              <ul>\n              ${e.languages.map(e=>`<li>${e.name}</li>`).join(" ")}</ul>\n            </div>\n            <img src="${e.flag}" alt="This is the flag!" class="flag" width="300px"></div>`}markupCountriesNames(e){const t=`${e.map(e=>`<div class="country-name">${e.name}</div>`).join(" ")}`,s=this.shadowRoot.querySelector(".country-name");return console.log("qwe:",s),t}removeListItems(){this.shadowRoot.querySelector(".alert-list").innerHTML="",this.shadowRoot.querySelector(".country__description--js").innerHTML=""}async showCountriesData(e){e.preventDefault();const t=this.shadowRoot.querySelector("input").value.toLowerCase();await async function(){const e=await fetch("https://restcountries.eu/rest/v2/");return await e.json()}().then(e=>e.filter(e=>e.name.toLowerCase().includes(t))).then(e=>{const s=Array.from(e);if(0===s.length)this.matchAlert.open("No matches!");else if(0===t.length)this.removeListItems();else if(1===s.length){this.removeListItems(),this.shadowRoot.querySelector(".country__description--js").insertAdjacentHTML("beforeend",this.markupCountry(e[0]))}else if(s.length>1&&s.length<=10){this.removeListItems();const t=this.markupCountriesNames(e);this.shadowRoot.querySelector(".alert-list").insertAdjacentHTML("beforeend",t);const s=this.shadowRoot.querySelectorAll(".country-name");console.log("All Countries:",s),console.log("allCountries[0]:",s[0])}else this.removeListItems(),this.matchAlert.open("Too many matches!")})}});customElements.define("alert-matches-element",class extends Y{static get properties(){return{msg:{type:String},opened:{type:Boolean}}}render(){return R`
      <style>
        div {
          position: fixed;
          top: 100px;
